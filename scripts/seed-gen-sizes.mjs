...
const DEFS = [
  // 2026-09-03 자사몰 실측 재확정: 웹 롤링 1920×680 · 모바일 800×907 (banner-sizes.ts 와 동기)
  ['자사몰', 'yb-web',   '🏠 자사몰 웹 메인',     1920, 680, '배너 스튜디오 자사몰 웹(1920×680)과 동일 비율'],
  ['자사몰', 'yb-mo',    '📱 자사몰 모바일 메인',  1080, 1224, '배너 모바일(800×907)과 같은 비율 · 큰 해상도로 생성'],
