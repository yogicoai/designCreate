...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      /*
       * 드롭박스 — 팀 드롭박스 제품사진(9,565장) 보관함 겸 검수 화면.
       * 레퍼런스와 같은 무리에 두되 컬렉션은 따로다(dropbox_assets) — 레퍼런스 4,600장에
       * 섞으면 기존 촬영·모델컷 작업이 묻힌다는 사용자 판단 (2026-09-21).
       */
      { href: '/dropbox', label: '드롭박스', icon: '📦', badge: 'N' },
